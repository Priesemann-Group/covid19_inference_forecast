...
### General
We show three different scenarios starting today (see date of latest updated). One
...
the current estimate (dark blue), a third one with a reproduction number of R=1.3 (light blue). Please take the numbers as rough orientation only.
<p float="left">
