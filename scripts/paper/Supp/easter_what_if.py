...
# @Last Modified: 2020-05-04 17:04:58
# ------------------------------------------------------------------------------ #
...
change_points_C.append(
    dict(  # Worse impact of relaxed restrictions, back to lambda 1
        pr_mean_date_begin_transient=datetime.datetime(2020, 4, 19),
        pr_sigma_date_begin_transient=1,
        pr_median_lambda=(0.13 + 0.25) / 2.0,  # between lambda_1 and lambda_2
        pr_sigma_lambda=0.3,
    ),
)
